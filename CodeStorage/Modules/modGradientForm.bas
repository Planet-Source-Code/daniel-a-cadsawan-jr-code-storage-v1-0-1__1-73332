Attribute VB_Name = "modGradientForm"
...
Public Sub PaintGradient(frm As Form, Red1 As Integer, Green1 As Integer, _
    Blue1 As Integer, Red2 As Integer, Green2 As Integer, Blue2 As Integer)
    Dim WinRect     As RECT
